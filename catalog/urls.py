...
from catalog.views import ProductCreateView,ProductUpdateView,CategoryCreateView,CategoryUpdateView,CategoryDeleteView
...
urlpatterns = [
    ...
    path("catalog/category/create", CategoryCreateView.as_view(), name="category_create"),
    ...
    path('catalog/category/<int:pk>/delete/', CategoryDeleteView.as_view(), name='category_delete'),
    ...
    path('catalog/product_mod_list/', ProductModListView.as_view(), name='product_mod_list'),
    path("catalog/product_mod_detail/<int:pk>/", ProductModDetailView.as_view(), name='product_mod_detail'),
